...
const contractABI = require("../artifacts/contracts/Foundryforge.sol/Foundryforge.json").abi;

program
    .name("foundryforge-cli")
    .description("CLI tool for Foundryforge smart contract")
    .version("1.0.0");
