 ...
 * This file demonstrates how to integrate Foundryforge with a web frontend
 */

// For React/Vue/Angular applications
export class FoundryforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FoundryforgeClient(provider, contractAddress);
